...
//		http.authorizeRequests().antMatchers("/").not().authenticated().and().formLogin();

		http.authorizeRequests().antMatchers("/").permitAll()
				.antMatchers("/departments", "/asignaturas", "/departments", "/departmens/add", "/grados/addGrado",
						"/grados/addasignatura")
				.hasRole("ADMIN").antMatchers("/about", "/services", "/alumnos/*").hasRole("USER")
				.antMatchers("/register").not().authenticated().and().formLogin();
	}
