...
import org.iesalixar.servidor.dto.ProfesorDepartamentoDTO;
...
public class DepartamentoController {
	...
	public String addProfesorDepartmentoGet(Model model) {
		...
		model.addAttribute("profesor", profesorService.findDepartamentoIsNull()); //Lista con todos los profesores que tengan departamento nulo
