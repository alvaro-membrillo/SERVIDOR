				...
				<c:if test="${sessionScope.usuario==null}">
					<form method="post">
						...
						<label for="email" class="form-label">Email</label> <input
							...
							required /> <label for="firstName" class="form-label">FirstName</label>
						<input type="text" class="form-control" id="firstName"
							name="firstName" required /> <label for="lastName"
							class="form-label">LastName</label> <input type="text"
							class="form-control" id="lastName" name="lastName" required /> <input
							type="submit" class="btn btn-primary w-100 mt-3" value="ENTRAR" />
					</form>
